...
class RussoundDriver:
    ...
    def __init__(self):
        ...
        self.controller: RussoundController | None = None
        self.entities: dict[str, media_player.MediaPlayer] = {}
    ...
    def _get_zone_state(self, zone_id: int) -> str:
        """Get zone state."""
    ...
    async def handle_command(
        self, entity: media_player.MediaPlayer, cmd_id: str, params: dict[str, Any] | None = None
    ) -> ucapi.StatusCodes:
    ...
    def handle_zone_update(self, zone_id: int, updates: dict[str, Any]) -> None:
        """Handle zone state updates from controller."""
        entity_id = f"zone_{zone_id}"
        asyncio.create_task(self._update_entity(entity_id))

    async def _update_entity(self, entity_id: str) -> None:
        """Update entity state."""
    ...
    async def _update_all_entities(self) -> None:
